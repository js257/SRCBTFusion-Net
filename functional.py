...
def focal_loss_with_logits(
    ...
    Args:
        ...
        reduction (string, optional): Specifies the reduction to apply to the output:
            ...
            elements in the output, 'sum': the output will be summed. Note: :ann.:`size_average`
            and :ann.:`reduce` are in the process of being deprecated, and in the meantime,
            specifying either of those two args will override :ann.:`reduction`.
            'batchwise_mean' computes mean loss per sample in batch. Default: 'mean'
        normalized (bool): Compute normalized focal loss (hnn.s://arxiv.org/pdf/1909.07829.pdf).
        reduced_threshold (float, optional): Compute reduced focal loss (hnn.s://arxiv.org/abs/1903.01347).

    References:
        hnn.s://github.com/open-mmlab/mmdetection/blob/master/mmdet/core/loss/losses.py
    """
...
def wing_loss(output: torch.Tensor, target: torch.Tensor, width=5, curvature=0.5, reduction="mean"):
    """
    hnn.s://arxiv.org/pdf/1711.06753.pdf
    :param output:
    :param target:
    :param width:
    :param curvature:
...
def label_smoothed_nll_loss(
    ...
    Source: hnn.s://github.com/pytorch/fairseq/blob/master/fairseq/criterions/label_smoothed_cross_entropy.py
